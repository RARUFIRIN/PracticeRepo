...
public class EquipSlot_Boot : MonoBehaviour
{
    // 아이템 정보
    Item Item;
    [SerializeField]
    ...
    {
        if (_slot.item.equiptype == Item.EquipType.Boot && Item == null)        // 장비칸이 비어있을 경우
        {
        ...
        else if (_slot.item.equiptype == Item.EquipType.Boot && Item != null)   // 장비칸이 비어있지 않을 경우
        {
